...
**Assertion consumer service URL / Single Sign-On URL / Destination URL:** [https://app.merdekasurvey.com/api/auth/saml/callback](https://app.merdekasurvey.com/api/auth/saml/callback)

**Entity ID / Identifier / Audience URI / Audience Restriction:** [https://saml.merdekasurvey.com](https://saml.merdekasurvey.com)

> **Note:** [https://saml.merdekasurvey.com](https://saml.merdekasurvey.com) is hardcoded in Formbricks — do not replace it with your instance URL. It is the fixed SP Entity ID and must match exactly as shown in SAML assertions.
...
<Steps>
  ...
  <Step title="Enter the SAML Integration Settings as shown and click Next">
    ...
    - **Audience URI (SP Entity ID)**: `https://saml.merdekasurvey.com` (hardcoded; do not replace with your instance URL)
