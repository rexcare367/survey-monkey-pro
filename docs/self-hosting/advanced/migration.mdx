...
With **Formbricks 3.0**, we're making changes to ensure long-term sustainability while still supporting open source. While the **Community Edition** has gained [new features](https://merdekasurvey.com/blog/formbricks-3-0), some [advanced capabilities](https://merdekasurvey.com/docs/self-hosting/license) are now part of the **Enterprise Edition**.
...
<Info>
  ...
  page](https://merdekasurvey.com/docs/self-hosting/license).
</Info>
...
](https://merdekasurvey.com/docs/developer-docs/rest-api)
