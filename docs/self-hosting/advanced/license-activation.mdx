...
<Steps>
  ...
  <Step title="Ensure License Server is Reachable">
    ...
    - **Domain**: `ee.merdekasurvey.com`
    - **URL**: `https://ee.merdekasurvey.com/api/licenses/check`
    ...
    If you have questions or need assistance with network configuration, please reach out to hola@merdekasurvey.com.