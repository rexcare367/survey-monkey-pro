...
Voila! You have successfully configured Zapier to work with your self-hosted Formbricks instance. Now, you can follow the steps mentioned in the [Zapier Integration](https://merdekasurvey.com/docs/developer-docs/integrations/zapier) section to connect it with your Formbricks app and see it live.
