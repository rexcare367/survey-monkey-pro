...
For general setup instructions, refer to our [comprehensive ActivePieces integration guide](https://merdekasurvey.com/docs/xm-and-surveys/core-features/integrations/activepieces).
...
Instead of using `app.merdekasurvey.com` as your `APP_URL`, you must substitute this with your own self-hosted Formbricks instance URL.
