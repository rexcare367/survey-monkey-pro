...
1. Create new Feedback Box at app.merdekasurvey.com
...
Then, create a new survey and look for the [Feedback Box template](https://merdekasurvey.com/survey-templates/feedback-box):
