...
1. Create new Churn Survey at [app.merdekasurvey.com](https://app.merdekasurvey.com/)
...
Click on "Create Survey" and choose the template [Churn Survey](https://merdekasurvey.com/survey-templates/churn-survey):
