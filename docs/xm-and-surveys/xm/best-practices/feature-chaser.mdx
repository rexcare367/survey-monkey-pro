...
- Create new Feature Chaser survey at [app.merdekasurvey.com](https://app.merdekasurvey.com/)
...
Click on "Create Survey" and choose the template [Feature Chaser](https://merdekasurvey.com/survey-templates/feature-chaser):
