...
1. Create new Interview Prompt at [app.merdekasurvey.com](https://app.merdekasurvey.com/)
...
Click on "Create Survey" and choose the template [Interview Prompt](https://merdekasurvey.com/survey-templates/interview-prompt):
