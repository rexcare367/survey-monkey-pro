...
1. Create new 'Improve Newsletter Content' survey at [app.merdekasurvey.com](https://app.merdekasurvey.com/)
...
If you don't have an account yet, create one at [app.merdekasurvey.com](https://app.merdekasurvey.com/auth/signup)

Then, create a new survey and look for the [Improve Newsletter Content template](https://merdekasurvey.com/survey-templates/improve-newsletter-content):
