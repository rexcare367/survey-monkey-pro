...
First, make sure you have a Formbricks account. If not, you can create one [here](https://app.merdekasurvey.com):
...
Congratulations! You’ve successfully created a Quiz with Formbricks. You can play around with the quiz that we just created [here](https://app.merdekasurvey.com/s/cm2wwt3vu0001ir8o7ys0bezz).
