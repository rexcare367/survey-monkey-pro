...
Create a survey in Formbricks (UI) or programmatically via the Management API. Read more about the API endpoint [here](https://merdekasurvey.com/docs/api-reference/management-api--survey/create-survey).  
...
Get the survey schema using the Formbricks API. Read more about the API endpoint [here](https://merdekasurvey.com/docs/api-reference/management-api--survey/get-survey-by-id).
...
More about the Endpoint [here](https://merdekasurvey.com/docs/api-reference/client-api--environment/get-environment-state).
...
Post responses directly from the browser to Formbricks Client API. Read more about it [here](https://merdekasurvey.com/docs/api-reference/client-api--response/create-response).  
...
Configure webhooks in Formbricks to push response data to your system. Read more about Webhooks [here](https://merdekasurvey.com/docs/xm-and-surveys/core-features/integrations/webhooks#webhooks).
...
Fetch responses periodically from your backend, read more about the Endpoint [here](https://merdekasurvey.com/docs/api-reference/management-api--response/get-survey-responses).
