...
<Steps>
  <Step title="Create a free Formbricks Cloud account">
    While you can [self-host](/self-hosting/overview) Formbricks, the quickest and easiest way to get started is with the free Cloud plan. Just [sign up here](https://app.merdekasurvey.com/auth/signup) and click through the onboarding.
