...
<div style="position: relative; height:100vh; max-height:100vh; overflow:auto;">
  <iframe
    src="https://app.merdekasurvey.com/s/<your-surveyId>"
    frameborder="0"
...
window.addEventListener("message", (event) => {
  // Replace 'https://app.merdekasurvey.com' with the actual web app url
  if (
    event.origin === "https://app.merdekasurvey.com" &&
