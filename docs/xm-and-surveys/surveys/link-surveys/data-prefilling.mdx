...
```sh Example URL
https://app.merdekasurvey.com/s/clin3dxja02k8l80hpwmx4bjy?question_id_1=answer_1&question_id_2=answer_2&skipPrefilled=true
```
...
app.merdekasurvey.com/s/clin3dxj?question_id_1=answer_1&skipPrefilled=true
```
...
```sh Rating Question
https://app.merdekasurvey.com/s/clin3yxja52k8l80hpwmx4bjy?rating_question_id=5
```
...
```sh NPS Questions
https://app.merdekasurvey.com/s/clin3yxja52k8l80hpwmx4bjy?nps_question_id=10
```
...
https://app.merdekasurvey.com/s/clin3yxja52k8l80hpwmx4bjy?single_select_question_id=Very%20disappointed
```
...
https://app.merdekasurvey.com/s/clin3yxja52k8l80hpwmx4bjy?multi_select_question_id=Sun%2CPalms%2CBeach
```
...
https://app.merdekasurvey.com/s/clin3yxja52k8l80hpwmx4bjy?openText_question_id=I%20love%20Formbricks
```
...
```txt CTA Question
https://app.merdekasurvey.com/s/clin3yxja52k8l80hpwmx4bjy?cta_question_id=dismissed
```
...
https://app.merdekasurvey.com/s/clin3yxja52k8l80hpwmx4bjy?consent_question_id=accepted
```
...
https://app.merdekasurvey.com/s/clin3yxja52k8l80hpwmx4bjy?pictureSelection_question_id=1%2C2%2C3
```
