...
<Steps>
  <Step title="Create a Formbricks cloud account">
    While you can [self-host](/self-hosting) Formbricks, the fastest and easiest way to get started is with the free Cloud plan. Simply [sign up](https://app.merdekasurvey.com/auth/signup) here, follow the onboarding steps, and choose the "Formbricks Surveys" option.
