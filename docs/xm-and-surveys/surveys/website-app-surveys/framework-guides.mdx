...
<CardGroup cols={2}>
  <Card title="HTML" icon="html5" color="orange" href="#html">
    [All you need to do is add three lines of code to your HTML script, and that's it!](https://merdekasurvey.com/docs/app-surveys/framework-guides#html)
  </Card>
...
<Card title="React.js" icon="react" color="lightblue" href="#react-js">
  ...
  go!](https://merdekasurvey.com/docs/app-surveys/framework-guides#react-js)
</Card>
...
<Card title="Next.js" icon="react" href="#next-js">
  ...
  structure.](https://merdekasurvey.com/docs/app-surveys/framework-guides#next-js)
</Card>
...
<Card title="React Native" icon="react" color="lightblue" href="#react-native">
  ...
  support.](https://merdekasurvey.com/docs/app-surveys/framework-guides#react-native)
</Card>

<Card title="Swift" icon="swift" color="orange" href="#swift">
  [Use our iOS SDK to quickly integrate surveys into your iOS
  applications.](https://merdekasurvey.com/docs/app-surveys/framework-guides#swift)
</Card>
...
<Card title="Android" icon="android" color="green" href="#android">
  ...
  SDK.](https://merdekasurvey.com/docs/app-surveys/framework-guides#android)
</Card>
...
!function(){
    var appUrl = "https://app.merdekasurvey.com"; // use PUBLIC_URL if you are using multi-domain setup, otherwise use WEBAPP_URL
