...
Use our documented methods on the **Creation**, **List**, and **Deletion** endpoints of the Webhook API mentioned in our [API v2 playground](https://merdekasurvey.com/docs/api-v2-reference/management-api-%3E-webhooks/get-webhooks).
...
[
  {
    "data": {
      ...
      "meta": {
        "country": "DE",
        "url": "https://app.merdekasurvey.com/s/surveyId",
        "userAgent": {
          "browser": "Chrome",
          "device": "desktop",
          "os": "macOS"
