...
2. Create a [free Formbricks account](https://app.merdekasurvey.com/auth/signup)
...
This is super straight forward: Go to [app.merdekasurvey.com/auth/signup](https://app.merdekasurvey.com/auth/signup), create the account, verify your email and you’re in!
