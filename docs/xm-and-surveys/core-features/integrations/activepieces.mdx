...
Enter the Formbricks API Host and API Key. API Host is by default set to https://app.merdekasurvey.com but can be modified for self-hosting instances. Learn how to get an API Key from the [API Key tutorial](/api-reference/rest-api#how-to-generate-an-api-key).
